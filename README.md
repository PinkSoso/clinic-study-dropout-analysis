...
Résultats clés :          
        ...
        4. Modèle prédictif (Random Forest, ~70% de précision) pour anticiper le risque de dropout => **prédiction en fonction de l'adherence_scoring le genre féminin sans souci de santé est plus a risque modéré de drop out à 80% en phase 3**   
